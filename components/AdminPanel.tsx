            ...
            <div className="max-w-7xl mx-auto">
                <header className="flex items-center justify-between pb-4 border-b border-parsa-gray-200 mb-6">
                    <div className="flex items-center gap-3">
                        <img src="/icons/logo.svg" alt="Parsa Institute" className="h-10 w-auto"/>
                        <h1 className="text-2xl font-bold text-parsa-gray-800">پنل مدیریت</h1>
                    </div>
                    <button 
                        onClick={onLogout}
                ...
                <div className="mb-6 text-left">
                    <button
                        onClick={onAdd}
                        className="bg-parsa-blue-500 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-parsa-blue-600 transition-colors shadow-sm inline-flex items-center gap-2"
                    >
                        ...
                        <tbody>
                            {courses.map(course => (
                                <tr key={course.id} className="bg-white border-b hover:bg-parsa-gray-50">
                                    <td className="px-6 py-4 font-medium text-parsa-gray-900 whitespace-nowrap">{course.language}</td>
                                    ...
                                    <td className="px-6 py-4 text-center space-x-2 space-x-reverse">
                                        <button onClick={() => onEdit(course)} className="font-medium text-parsa-blue-600 hover:underline">ویرایش</button>
