...
const Header: React.FC<HeaderProps> = ({ courseCount, onOpenProfile }) => {
    return (
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        <div className="hidden lg:flex items-center gap-4">
                         ...
                         <button onClick={onOpenProfile} title="پروفایل کاربری" className="p-2 rounded-full hover:bg-parsa-gray-100 transition-colors lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-parsa-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                        </button>
