...
const benefits = [
    { 
        icon: <svg className="w-6 md:w-8 h-6 md:h-8 text-parsa-brown-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>, 
        title: "اساتید مجرب و Native", 
        description: "بهره‌گیری از بهترین اساتید با تجربه بین‌المللی",
        color: "brown"
    },
    { 
        icon: <svg className="w-6 md:w-8 h-6 md:h-8 text-parsa-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path></svg>, 
        title: "مدرک معتبر", 
        description: "ارائه مدرک رسمی و معتبر پایان دوره",
        color: "orange"
    },
    { 
        icon: <svg className="w-6 md:w-8 h-6 md:h-8 text-parsa-brown-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5z"></path><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222 4 2.222V20M12 14.75L2 9l10-5 10 5-10 5.75z"></path></svg>, 
        title: "متدولوژی مدرن", 
        description: "جدیدترین روش‌های آموزشی برای یادگیری سریع و عمیق",
        color: "brown"
    },
    { 
        icon: <svg className="w-6 md:w-8 h-6 md:h-8 text-parsa-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9V3m0 18a9 9 0 009-9m-9 9a9 9 0 00-9-9"></path></svg>, 
...
const Benefit: React.FC<typeof benefits[0]> = ({ icon, title, description, color }) => {
     const colorClasses = {
        orange: 'bg-parsa-orange-100',
        brown: 'bg-parsa-brown-100',
    };
    return (
        <div className="text-center">
            ...
            <h3 className="text-lg md:text-xl font-bold mb-2 text-parsa-brown-800">{title}</h3>
        ...
        <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-2xl md:text-4xl font-bold mb-4 text-parsa-brown-800">چرا موسسه زبان پارسا؟</h2>
