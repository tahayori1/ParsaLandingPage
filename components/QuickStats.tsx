                ...
                <div className="bg-white rounded-2xl shadow-xl p-4 md:p-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                        <div className="text-center">
                            <div className="text-xl md:text-3xl font-bold text-parsa-blue-600 mb-2">{languageCount}+</div>
                            <p className="text-xs md:text-sm text-parsa-gray-500">زبان زنده دنیا</p>
                        </div>
                        <div className="text-center">
                            <div className="text-xl md:text-3xl font-bold text-parsa-blue-600 mb-2">{courseCount}</div>
                            <p className="text-xs md:text-sm text-parsa-gray-500">دوره فعال</p>
                        </div>
                        <div className="text-center">
                            <div className="text-xl md:text-3xl font-bold text-parsa-blue-600 mb-2">۵۰+</div>
                            <p className="text-xs md:text-sm text-parsa-gray-500">استاد مجرب</p>
                        </div>
                        <div className="text-center">
                             <div className="text-xl md:text-3xl font-bold text-parsa-blue-600 mb-2">۵,۰۰۰+</div>
