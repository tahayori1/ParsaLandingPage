        ...
        <section className="bg-gradient-to-r from-parsa-brown-700 to-parsa-brown-900 text-white py-12 md:py-16">
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href={`https://wa.me/98${whatsappNumber.substring(1)}`} target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold text-base md:text-lg inline-flex items-center justify-center gap-2 transition-all" style={{ direction: 'ltr' }}>
