...
const RecentlyViewedCourseCard: React.FC<{course: Course, onClick: () => void}> = ({ course, onClick }) => (
    ...
    >
        ...
        <div className="overflow-hidden">
            ...
            <p className="text-xs font-semibold text-parsa-orange-600 mt-1">{formatPrice(course.price)}</p>
        </div>
    </div>
);
        ...
        <section className="py-16 bg-parsa-gray-50">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-2xl md:text-4xl font-bold mb-4 text-parsa-brown-800">بازدیدهای اخیر شما</h2>
